...
export declare class CropperAmm implements Amm {
    ...
    createSwapInstructions({ sourceMint, sourceTokenAccount, destinationTokenAccount, userTransferAuthority, amount, minimumOutAmount, platformFee, }: SwapParams): TransactionInstruction[];
