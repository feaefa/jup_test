...
const ZERO_FRACTION = /*#__PURE__*/new math.Fraction( /*#__PURE__*/JSBI__default["default"].BigInt(0), /*#__PURE__*/JSBI__default["default"].BigInt(1));
...
const [TOKEN_LEDGER] = /*#__PURE__*/pubkey.findProgramAddressSync([/*#__PURE__*/Buffer.from('token_ledger')], JUPITER_PROGRAM_ID);
...
function createMercurialExchangeInstruction(swapLayout, userSourceTokenAccountAddress, userDestinationTokenAccountAddress, user, amount, minimumOutAmount, platformFee) {
  ...
  return JUPITER_PROGRAM.instruction.mercurialExchange(amount ? new BN.BN(amount) : amount, new BN.BN(minimumOutAmount), (_platformFee$feeBps = platformFee === null || platformFee === void 0 ? void 0 : platformFee.feeBps) !== null && _platformFee$feeBps !== void 0 ? _platformFee$feeBps : 0, {
...
function createSerumSwapInstruction(market, inputMint, openOrdersAddress, userSourceTokenAccountAddress, userDestinationTokenAccountAddress, user, amount, minimumOutAmount, platformFee, referrer) {
  ...
  return JUPITER_PROGRAM.instruction.serumSwap(side, amount ? new BN.BN(amount) : amount, new BN.BN(minimumOutAmount), (_platformFee$feeBps2 = platformFee === null || platformFee === void 0 ? void 0 : platformFee.feeBps) !== null && _platformFee$feeBps2 !== void 0 ? _platformFee$feeBps2 : 0, {
...
function createTokenSwapInstruction(tokenSwapState, inputMint, userSourceTokenAccountAddress, userDestinationTokenAccountAddress, user, amount, minimumOutAmount, platformFee, isStep) {
  ...
  return (isStep ? JUPITER_PROGRAM.instruction.stepTokenSwap : JUPITER_PROGRAM.instruction.tokenSwap)(amount ? new BN.BN(amount) : amount, new BN.BN(minimumOutAmount), (_platformFee$feeBps3 = platformFee === null || platformFee === void 0 ? void 0 : platformFee.feeBps) !== null && _platformFee$feeBps3 !== void 0 ? _platformFee$feeBps3 : 0, {
    accounts: {
...
function createSenchaSwapInstruction(poolState, sourceMint, userSourceTokenAccountAddress, userDestinationTokenAccountAddress, user, amount, minimumOutAmount, platformFee) {
  ...
  return JUPITER_PROGRAM.instruction.senchaExchange(amount ? new BN.BN(amount) : amount, new BN.BN(minimumOutAmount), (_platformFee$feeBps4 = platformFee === null || platformFee === void 0 ? void 0 : platformFee.feeBps) !== null && _platformFee$feeBps4 !== void 0 ? _platformFee$feeBps4 : 0, {
    accounts: {
...
function createCropperSwapInstruction(poolState, sourceMint, userSourceTokenAccountAddress, userDestinationTokenAccountAddress, user, feeAccount, amount, minimumOutAmount, platformFee) {
  ...
  return JUPITER_PROGRAM.instruction.cropperTokenSwap(amount ? new BN.BN(amount) : amount, new BN.BN(minimumOutAmount), (_platformFee$feeBps5 = platformFee === null || platformFee === void 0 ? void 0 : platformFee.feeBps) !== null && _platformFee$feeBps5 !== void 0 ? _platformFee$feeBps5 : 0, {
    accounts: {
...
function createRaydiumSwapInstruction(raydiumAmm, userSourceTokenAccountAddress, userDestinationTokenAccountAddress, user, amount, minimumOutAmount, platformFee) {
  ...
  return JUPITER_PROGRAM.instruction.raydiumSwapV2(amount ? new BN.BN(amount) : amount, new BN.BN(minimumOutAmount), (_platformFee$feeBps6 = platformFee === null || platformFee === void 0 ? void 0 : platformFee.feeBps) !== null && _platformFee$feeBps6 !== void 0 ? _platformFee$feeBps6 : 0, {
...
function createAldrinSwapInstruction(poolState, sourceMint, userSourceTokenAccountAddress, userDestinationTokenAccountAddress, user, amount, minimumOutAmount, platformFee) {
  ...
  return JUPITER_PROGRAM.instruction.aldrinSwap(amount ? new BN.BN(amount) : amount, new BN.BN(minimumOutAmount), side, (_platformFee$feeBps7 = platformFee === null || platformFee === void 0 ? void 0 : platformFee.feeBps) !== null && _platformFee$feeBps7 !== void 0 ? _platformFee$feeBps7 : 0, {
    accounts: {
...
function createAldrinV2SwapInstruction(poolState, sourceMint, userSourceTokenAccountAddress, userDestinationTokenAccountAddress, curve, user, amount, minimumOutAmount, platformFee) {
  ...
  const [side, userBaseTokenAccount, userQuoteTokenAccount] = sourceMint.equals(poolState.baseTokenMint) ? [Side.Ask, userSourceTokenAccountAddress, userDestinationTokenAccountAddress] : [Side.Bid, userDestinationTokenAccountAddress, userSourceTokenAccountAddress];
  return JUPITER_PROGRAM.instruction.aldrinV2Swap(amount ? new BN.BN(amount) : amount, new BN.BN(minimumOutAmount), side, (_platformFee$feeBps8 = platformFee === null || platformFee === void 0 ? void 0 : platformFee.feeBps) !== null && _platformFee$feeBps8 !== void 0 ? _platformFee$feeBps8 : 0, {
    accounts: {
...
function createRiskCheckAndFeeInstruction(userDestinationTokenAccount, userTransferAuthority, minimumOutAmount, platformFee) {
  ...
  return JUPITER_PROGRAM.instruction.riskCheckAndFee(new BN.BN(minimumOutAmount), (_platformFee$feeBps9 = platformFee === null || platformFee === void 0 ? void 0 : platformFee.feeBps) !== null && _platformFee$feeBps9 !== void 0 ? _platformFee$feeBps9 : 0, {
    accounts: {
...
function createOpenOrdersInstruction(market, user) {
  const [openOrders] = pubkey.findProgramAddressSync([Buffer.from('open_orders'), market.publicKey.toBuffer(), user.toBuffer()], JUPITER_PROGRAM_ID);
...
function createSaberExchangeInstruction(saberPool, inputMint, userSourceTokenAccountAddress, userDestinationTokenAccountAddress, user, amount, minimumOutAmount, platformFee) {
  ...
  return JUPITER_PROGRAM.instruction.saberExchange(amount ? new BN.BN(amount) : amount, new BN.BN(minimumOutAmount), (_platformFee$feeBps10 = platformFee === null || platformFee === void 0 ? void 0 : platformFee.feeBps) !== null && _platformFee$feeBps10 !== void 0 ? _platformFee$feeBps10 : 0, {
...
function createSaberAddDecimalsDepositInstruction(addDecimals, sourceTokenAccountAddress, destinationTokenAccountAddress, userTransferAuthority, amount, minimumOutAmount, platformFee) {
  ...
  const remainingAccounts = prepareRemainingAccounts(amount, platformFee === null || platformFee === void 0 ? void 0 : platformFee.feeAccount);
  return JUPITER_PROGRAM.instruction.saberAddDecimalsDeposit(amount ? new BN.BN(amount) : amount, new BN.BN(minimumOutAmount), (_platformFee$feeBps11 = platformFee === null || platformFee === void 0 ? void 0 : platformFee.feeBps) !== null && _platformFee$feeBps11 !== void 0 ? _platformFee$feeBps11 : 0, {
    accounts: {
...
function createSaberAddDecimalsWithdrawInstruction(addDecimals, sourceTokenAccountAddress, destinationTokenAccountAddress, userTransferAuthority, amount, minimumOutAmount, platformFee) {
  ...
  const remainingAccounts = prepareRemainingAccounts(amount, platformFee === null || platformFee === void 0 ? void 0 : platformFee.feeAccount);
  return JUPITER_PROGRAM.instruction.saberAddDecimalsWithdraw(amount ? new BN.BN(amount) : amount, new BN.BN(minimumOutAmount), (_platformFee$feeBps12 = platformFee === null || platformFee === void 0 ? void 0 : platformFee.feeBps) !== null && _platformFee$feeBps12 !== void 0 ? _platformFee$feeBps12 : 0, {
    accounts: {
      addDecimalsProgram: SABER_ADD_DECIMALS_PROGRAM_ID,
      wrapper: addDecimals.wrapper,
      wrapperMint: addDecimals.mint,
...
class RaydiumAmm {
  constructor(ammId, ammAccountInfo) {
    ...
    this.swapFeeNumerator = new splToken.u64(decoded.swapFeeNumerator);
    this.swapFeeDenominator = new splToken.u64(decoded.swapFeeDenominator);
  ...
  update(accountInfoMap) {
    ...
    const openOrders = serum.OpenOrders.fromAccountInfo(this.ammOpenOrders, ammOpenOrdersAccountInfo, ammOpenOrdersAccountInfo.owner); // TODO: Possibly better design is to have this passed to the ctor, so it isn't an independant instruction

    const decodedMarket = serum.Market.getLayout(this.serumProgramId).decode(serumMarketMarketInfo.data);
    const serumVaultSigner = pubkey.createProgramAddressSync([this.serumMarket.toBuffer(), decodedMarket.vaultSignerNonce.toArrayLike(Buffer, 'le', 8)], this.serumProgramId);
  ...
  getQuote({
    ...
    const inAmountBN = new BN__default["default"](String(amount));
    ...
    return {
      ...
      feeMint: sourceMint.toBase58(),
      feePct: Number(new Decimal__default["default"](this.swapFeeNumerator.toString()).div(this.swapFeeDenominator.toString()).toString()),
      priceImpactPct: Number(new Decimal__default["default"](outAmountWithoutPriceImpact.sub(outAmountBN).toString()).div(outAmountWithoutPriceImpact.toString()).toString())
    };
  }
...
function forecastBuy(market, orderBook, pcIn, takerFeePct) {
  ...
  const baseSizeLots = market.baseSizeLotsToNumber(new BN__default["default"](1));
  const quoteSizeLots = market.quoteSizeLotsToNumber(new BN__default["default"](1));
...
class SaberAmm {
  ...
  update(accountInfoMap) {
    ...
    this.calculator = new math.Stable(JSBI__default["default"].BigInt(this.stableSwap.state.targetAmpFactor.toString()), this.tokenAccounts.map(tokenAccount => {
      return JSBI__default["default"].BigInt(tokenAccount.amount.toString());
    }), [math.ONE, math.ONE], // TODO: How to get the token decimal?
  ...
  getQuote({
    ...
    const result = this.calculator.exchange(JSBI__default["default"].BigInt(amount), ZERO_FRACTION, inputIndex, outputIndex);
    return {
      notEnoughLiquidity: false,
      inAmount: amount,
...
class AldrinAmm {
  ...
  update(accountInfoMap) {
    ...
    if (!this.poolState.curveType) {
      this.calculator = new math.TokenSwapConstantProduct(this.tokenAccounts.map(tokenAccount => {
        return JSBI__default["default"].BigInt(tokenAccount.amount.toString());
      }), new math.Fraction(JSBI__default["default"].BigInt(this.poolState.fees.traderFee.numerator.toString()), JSBI__default["default"].BigInt(this.poolState.fees.traderFee.denominator.toString())), new math.Fraction(JSBI__default["default"].BigInt(this.poolState.fees.ownerFee.numerator.toString()), JSBI__default["default"].BigInt(this.poolState.fees.ownerFee.denominator.toString())));
      ...
      this.calculator = new math.TokenSwapStable(JSBI__default["default"].BigInt(amp), this.tokenAccounts.map(tokenAccount => {
        return JSBI__default["default"].BigInt(tokenAccount.amount.toString());
      }), new math.Fraction(JSBI__default["default"].BigInt(this.poolState.fees.traderFee.numerator.toString()), JSBI__default["default"].BigInt(this.poolState.fees.traderFee.denominator.toString())), new math.Fraction(JSBI__default["default"].BigInt(this.poolState.fees.ownerFee.numerator.toString()), JSBI__default["default"].BigInt(this.poolState.fees.ownerFee.denominator.toString())));
    }
  }
  ...
  getQuote({
    ...
    let result = this.calculator.exchange(JSBI__default["default"].BigInt(amount), ZERO_FRACTION, outputIndex);
    return {
      notEnoughLiquidity: false,
      inAmount: amount,
      outAmount: JSBI__default["default"].toNumber(result.expectedOutputAmount),
...
class SplTokenSwapAmm {
  ...
  update(accountInfoMap) {
    ...
    if (this.tokenSwapState.curveType === CurveType.ConstantProduct) {
      this.calculator = new math.TokenSwapConstantProduct(this.tokenAccounts.map(tokenAccount => {
        return JSBI__default["default"].BigInt(tokenAccount.amount.toString());
      }), new math.Fraction(JSBI__default["default"].BigInt(this.tokenSwapState.tradeFeeNumerator.toString()), JSBI__default["default"].BigInt(this.tokenSwapState.tradeFeeDenominator.toString())), new math.Fraction(JSBI__default["default"].BigInt(this.tokenSwapState.ownerTradeFeeNumerator.toString()), JSBI__default["default"].BigInt(this.tokenSwapState.ownerTradeFeeDenominator.toString())));
    } else if (this.tokenSwapState.curveType === CurveType.Stable) {
      this.calculator = new math.TokenSwapStable(JSBI__default["default"].BigInt(this.tokenSwapState.curveParameters[0]), this.tokenAccounts.map(tokenAccount => {
        return JSBI__default["default"].BigInt(tokenAccount.amount.toString());
      }), new math.Fraction(JSBI__default["default"].BigInt(this.tokenSwapState.tradeFeeNumerator.toString()), JSBI__default["default"].BigInt(this.tokenSwapState.tradeFeeDenominator.toString())), new math.Fraction(JSBI__default["default"].BigInt(this.tokenSwapState.ownerTradeFeeNumerator.toString()), JSBI__default["default"].BigInt(this.tokenSwapState.ownerTradeFeeDenominator.toString())));
    }
  }
...
class MercurialAmm {
  ...
  update(accountInfoMap) {
    ...
    this.calculator = new math.Stable(JSBI__default["default"].BigInt(this.swapLayout.amplificationCoefficient), this.tokenAccounts.map(tokenAccount => {
      return JSBI__default["default"].BigInt(tokenAccount.amount.toString());
    }), this.swapLayout.precisionMultipliers.map(precisionMultiplier => JSBI__default["default"].BigInt(precisionMultiplier)), new math.Fraction(JSBI__default["default"].BigInt(this.swapLayout.feeNumerator), JSBI__default["default"].BigInt(FEE_DENOMINATOR)));
  }
...
class CropperAmm {
  ...
  update(accountInfoMap) {
    ...
    this.calculator = new math.TokenSwapConstantProduct(this.tokenAccounts.map(tokenAccount => {
      return JSBI__default["default"].BigInt(tokenAccount.amount.toString());
    }), new math.Fraction(JSBI__default["default"].BigInt(this.params.fixedFeeNumerator), JSBI__default["default"].BigInt(this.params.feeDenominator)), new math.Fraction(JSBI__default["default"].BigInt(this.params.returnFeeNumerator), JSBI__default["default"].BigInt(this.params.feeDenominator)));
  }
...
class SenchaAmm {
  ...
  update(accountInfoMap) {
    ...
    this.calculator = new math.TokenSwapConstantProduct(this.tokenAccounts.map(tokenAccount => {
      return JSBI__default["default"].BigInt(tokenAccount.amount.toString());
    }), new math.Fraction(JSBI__default["default"].BigInt(this.poolState.tradeFeeKbps), JSBI__default["default"].BigInt(10000000)), new math.Fraction(math.ZERO, math.ZERO), false);
  }
...
async function getAllAmms(connection, cluster, marketUrl) {
  const marketsCache = await (await fetch__default["default"](marketUrl || MARKETS_URL[cluster])).json();
      ...
      for (const intersectionMarketMeta of intersectionMarketMetas) {
        if (isValidRoute(marketMeta.amm, intersectionMarketMeta.amm)) {
          routes.push({
            ...
            intermediateMint: new web3_js.PublicKey(mint)
          });
        }
      }
    }
...
async function createAndCloseWSOLAccount(connection, owner, amount) {
  ...
  result.instructions = [];
  const toAccount = await splToken.Token.getAssociatedTokenAddress(splToken.ASSOCIATED_TOKEN_PROGRAM_ID, splToken.TOKEN_PROGRAM_ID, WRAPPED_SOL_MINT, owner);
...
async function findOrCreateAssociatedAccountByMint(connection, payer, owner, mintAddress, unwrapSOL) {
  ...
  const toAccount = await splToken.Token.getAssociatedTokenAddress(splToken.ASSOCIATED_TOKEN_PROGRAM_ID, splToken.TOKEN_PROGRAM_ID, mint, owner);
...
async function routeBatchFetcher(connection, routes, externalAccountInfosMap) {
  ...
  if (!hasExternalAccountInfosMap) {
    ...
    if (accountsToFetch.length > 0) {
      const accountInfos = await chunkedGetMultipleAccountInfos(connection, accountsToFetch.map(account => new web3_js.PublicKey(account)));
...
class Jupiter {
  ...
  wrapUnwrapSOL = true) {
    ...
    this.exchange = async ({
      ...
      const sourceInstruction = inputMint.equals(WRAPPED_SOL_MINT) && this.wrapUnwrapSOL ? await createAndCloseWSOLAccount(connection, owner.publicKey, route.inAmount) : { ...getEmptyInstruction(),
        address: await splToken.Token.getAssociatedTokenAddress(splToken.ASSOCIATED_TOKEN_PROGRAM_ID, splToken.TOKEN_PROGRAM_ID, inputMint, owner.publicKey)
  ...
  static async load({
    ...
    }, defaultQuoteMintToReferrer] = await Promise.all([Jupiter.fetchTokenRouteSegments(connection, cluster, marketUrl), connection.getRecentBlockhashAndContext('processed'), getPlatformFeeAccounts(connection, new web3_js.PublicKey(JUPITER_WALLET))]);
