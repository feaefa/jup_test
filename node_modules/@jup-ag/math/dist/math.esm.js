...
var Stable = /*#__PURE__*/function () {
  ...
  _proto.getPriceImpact = function getPriceImpact(inputTradeAmountJSBI, expectedOutputAmountJSBI, inputIndex, outputIndex) {
    if (JSBI.equal(inputTradeAmountJSBI, ZERO) || JSBI.equal(this.tokenAmounts[inputIndex], ZERO) || JSBI.equal(this.tokenAmounts[outputIndex], ZERO)) {
  ...
  _proto.getMinimumOutputAmount = function getMinimumOutputAmount(expectedOutputAmount, slippageTolerance) {
    return JSBI.divide(JSBI.multiply(expectedOutputAmount, JSBI.subtract(slippageTolerance.denominator, slippageTolerance.numerator)), slippageTolerance.denominator);
  };
...
var TokenSwapStable = /*#__PURE__*/function () {
  ...
  _proto.getFees = function getFees(inputTradeAmount) {
    var tradingFee = JSBI.equal(this.traderFee.numerator, ZERO) ? ZERO : JSBI.divide(JSBI.multiply(inputTradeAmount, this.traderFee.numerator), this.traderFee.denominator);
    var ownerFee = JSBI.equal(this.ownerFee.numerator, ZERO) ? ZERO : JSBI.divide(JSBI.multiply(inputTradeAmount, this.ownerFee.numerator), this.ownerFee.denominator);
  ...
  _proto.getMinimumOutputAmount = function getMinimumOutputAmount(expectedOutputAmountJSBI, slippageTolerance) {
    return JSBI.divide(JSBI.multiply(expectedOutputAmountJSBI, JSBI.subtract(slippageTolerance.denominator, slippageTolerance.numerator)), slippageTolerance.denominator);
  };
...
var TokenSwapConstantProduct = /*#__PURE__*/function () {
  ...
  _proto.getExpectedOutputAmountWithNoSlippage = function getExpectedOutputAmountWithNoSlippage(inputTradeAmount, inputIndex, outputIndex) {
    ...
    var expectedOutputAmountWithNoSlippage = JSBI.divide(JSBI.multiply(inputTradeAmount, this.tokenAmounts[outputIndex]), this.tokenAmounts[inputIndex]);
...
export { Fraction, ONE, Stable, TWO, TokenSwapConstantProduct, TokenSwapStable, ZERO, abs, ceilingDivision, mulArray, sumArray, toDecimal };
