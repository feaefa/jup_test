...
var Curve = /*#__PURE__*/function () {
  function Curve(numberOfCurrencies, amplificationFactor, tokenAmounts, targetPrices) {
  ...
  _proto.exchange = function exchange(inputIndex, outputIndex, amount, minusOne) {
    if (minusOne === void 0) {
      minusOne = true;
    }
    ...
    var y = this.computeY(inputIndex, outputIndex, x);
  ...
  _proto.computeBaseY = function computeBaseY(inputIndex, outputIndex, amount) {
    var d = this.computeD();
    var xp = this.xp();
  ...
  _proto.computeY = function computeY(inputIndex, outputIndex, newTotalAmount) {
    var d = this.computeD();
    var xx = this.xp();
  ...
  _proto.computeD = function computeD() {
    var dPrev = ZERO;
    var xp = this.xp();
    var sum = sumArray(xp);
    var d = sum;
  ...
  _proto.xp = function xp() {
    var _this = this;

    return this.tokenAmounts.map(function (tokenAmount, index) {
...
var Stable = /*#__PURE__*/function () {
  function Stable(amp, tokenAmounts, targetPrices, traderFee) {
    this.tokenAmounts = void 0;
    this.targetPrices = void 0;
    ...
    this.curve = new Curve(JSBI__default["default"].BigInt(this.tokenAmounts.length), amp, this.tokenAmounts, this.targetPrices);
  }

  var _proto = Stable.prototype;

  _proto.exchange = function exchange(inputTradeAmount, slippageTolerance, inputIndex, outputIndex) {
    var outputAmountWithoutFees = this.getOutputAmount(inputTradeAmount, inputIndex, outputIndex);
  ...
  _proto.getPriceImpact = function getPriceImpact(inputTradeAmountJSBI, expectedOutputAmountJSBI, inputIndex, outputIndex) {
    if (JSBI__default["default"].equal(inputTradeAmountJSBI, ZERO) || JSBI__default["default"].equal(this.tokenAmounts[inputIndex], ZERO) || JSBI__default["default"].equal(this.tokenAmounts[outputIndex], ZERO)) {
      return new Decimal__default["default"](0);
    }

    var noSlippageOutputAmount = toDecimal(this.getOutputAmountWithNoSlippage(inputTradeAmountJSBI, inputIndex, outputIndex));
  ...
  _proto.getMinimumOutputAmount = function getMinimumOutputAmount(expectedOutputAmount, slippageTolerance) {
    return JSBI__default["default"].divide(JSBI__default["default"].multiply(expectedOutputAmount, JSBI__default["default"].subtract(slippageTolerance.denominator, slippageTolerance.numerator)), slippageTolerance.denominator);
  };

  _proto.getOutputAmount = function getOutputAmount(inputTradeAmount, inputIndex, outputIndex) {
    return this.curve.exchange(inputIndex, outputIndex, inputTradeAmount);
  };

  _proto.getOutputAmountWithNoSlippage = function getOutputAmountWithNoSlippage(inputTradeAmount, inputIndex, outputIndex) {
...
var TokenSwapStable = /*#__PURE__*/function () {
  function TokenSwapStable(amp, tokenAmounts, traderFee, ownerFee) {
    this.tokenAmounts = void 0;
    this.traderFee = void 0;
  ...
  _proto.exchange = function exchange(inputTradeAmount, slippageTolerance, outputIndex) {
    var inputIndex = outputIndex === 0 ? 1 : 0;
    var expectedOutputAmount = this.getExpectedOutputAmount(inputTradeAmount, inputIndex, outputIndex);
    return {
      priceImpact: this.getPriceImpact(inputTradeAmount, expectedOutputAmount, inputIndex, outputIndex),
  ...
  _proto.getPriceImpact = function getPriceImpact(inputTradeAmountJSBI, expectedOutputAmountJSBI, inputIndex, outputIndex) {
    ...
    var noSlippageOutputAmount = toDecimal(this.getExpectedOutputAmountWithNoSlippage(inputTradeAmountJSBI, inputIndex, outputIndex));
    var expectedOutputAmount = toDecimal(expectedOutputAmountJSBI);
    var impact = noSlippageOutputAmount.sub(expectedOutputAmount).div(noSlippageOutputAmount);
    return impact;
  };
  ...
  _proto.getFees = function getFees(inputTradeAmount) {
    var tradingFee = JSBI__default["default"].equal(this.traderFee.numerator, ZERO) ? ZERO : JSBI__default["default"].divide(JSBI__default["default"].multiply(inputTradeAmount, this.traderFee.numerator), this.traderFee.denominator);
    var ownerFee = JSBI__default["default"].equal(this.ownerFee.numerator, ZERO) ? ZERO : JSBI__default["default"].divide(JSBI__default["default"].multiply(inputTradeAmount, this.ownerFee.numerator), this.ownerFee.denominator);
    return JSBI__default["default"].add(tradingFee, ownerFee);
  };

  _proto.getExpectedOutputAmount = function getExpectedOutputAmount(inputTradeAmount, inputIndex, outputIndex) {
  ...
  _proto.getExpectedOutputAmountWithNoSlippage = function getExpectedOutputAmountWithNoSlippage(inputTradeAmount, inputIndex, outputIndex) {
    var inputTradeAmountLessFees = this.getInputAmountLessFees(inputTradeAmount);
    return this.getOutputAmountWithNoSlippage(inputTradeAmountLessFees, inputIndex, outputIndex);
  };

  _proto.getMinimumOutputAmount = function getMinimumOutputAmount(expectedOutputAmountJSBI, slippageTolerance) {
    return JSBI__default["default"].divide(JSBI__default["default"].multiply(expectedOutputAmountJSBI, JSBI__default["default"].subtract(slippageTolerance.denominator, slippageTolerance.numerator)), slippageTolerance.denominator);
  };
  ...
  _proto.getOutputAmount = function getOutputAmount(inputTradeAmountLessFees, inputIndex, outputIndex) {
    return this.curve.exchange(inputIndex, outputIndex, inputTradeAmountLessFees, false);
  };

  _proto.getOutputAmountWithNoSlippage = function getOutputAmountWithNoSlippage(inputTradeAmountLessFees, inputIndex, outputIndex) {
...
var TokenSwapConstantProduct = /*#__PURE__*/function () {
  function TokenSwapConstantProduct(tokenAmounts, traderFee, ownerFee, feesOnInput) {
  ...
  _proto.exchange = function exchange(inputTradeAmount, slippageTolerance, outputIndex) {
    ...
    var expectedOutputAmount = this.getExpectedOutputAmount(newInputTradeAmount, inputIndex, outputIndex);
  ...
  _proto.getExpectedOutputAmountWithNoSlippage = function getExpectedOutputAmountWithNoSlippage(inputTradeAmount, inputIndex, outputIndex) {
    if (JSBI__default["default"].equal(this.tokenAmounts[inputIndex], ZERO)) {
      return this.tokenAmounts[outputIndex];
    }

    var expectedOutputAmountWithNoSlippage = JSBI__default["default"].divide(JSBI__default["default"].multiply(inputTradeAmount, this.tokenAmounts[outputIndex]), this.tokenAmounts[inputIndex]);
  ...
  _proto.getOutputAmount = function getOutputAmount(inputTradeAmount, inputIndex, outputIndex) {
    var _ref = [this.tokenAmounts[inputIndex], this.tokenAmounts[outputIndex]],
        poolInputAmount = _ref[0],
        poolOutputAmount = _ref[1];
    var invariant = this.getInvariant();
  ...
  _proto.getInvariant = function getInvariant() {
    return JSBI__default["default"].multiply(this.tokenAmounts[0], this.tokenAmounts[1]);
  };
