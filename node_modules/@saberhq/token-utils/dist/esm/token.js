...
Token.fromMint = (mint, decimals, opts = {}) => {
    ...
    return new Token(Object.assign(Object.assign({}, opts), { 
        ...
        // optional
        name: (_b = opts.name) !== null && _b !== void 0 ? _b : `Token ${mint.toString().slice(0, 4)}`, symbol: (_c = opts.symbol) !== null && _c !== void 0 ? _c : mint.toString().slice(0, 5), chainId: (_d = opts.chainId) !== null && _d !== void 0 ? _d : ChainId.Localnet }));
};
/**
...
export const CHAIN_ID_TO_NETWORK = Object.entries(NETWORK_TO_CHAIN_ID).reduce((acc, [network, env]) => (Object.assign(Object.assign({}, acc), { [env]: network })), {});
/**
