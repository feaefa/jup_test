...
export const mintNFT = (provider, mintKP, owner = provider.wallet.publicKey) => __awaiter(void 0, void 0, void 0, function* () {
    // Temporary mint authority
    const tempMintAuthority = provider.wallet.publicKey;
    // Mint for the NFT
    const tx = yield createInitMintInstructions({
        provider,
        mintKP,
        decimals: 0,
    ...
    const { address, instruction } = yield getOrCreateATA({
        provider,
