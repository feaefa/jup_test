...
exports.sleep = exports.getTokenAccount = exports.getMintInfo = exports.createAccountRentExempt = exports.createTokenAccountInstrs = exports.createMintAndVault = exports.createMintInstructions = exports.createToken = exports.createMint = exports.SPL_SHARED_MEMORY_ID = exports.token = void 0;
 ...
 * @returns
 */
function createToken(provider, authority, decimals = 6) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        return _1.Token.fromMint(yield createMint(provider, authority, decimals), decimals);
    });
}
    ...
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        const instructions = [
            web3_js_1.SystemProgram.createAccount({
                ...
                lamports: yield provider.connection.getMinimumBalanceForRentExemption(_1.MintLayout.span),
