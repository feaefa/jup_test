 ...
 */
const initializeStableSwap = (provider, stableSwapAccount, initializeSwapInstruction) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
...
const initializeSwapTokenInfo = ({ provider, mint, authority, admin, }) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
 ...
 * - args.config.stableSwapAccount -- This account is used once then its key is no longer relevant
 */
const createInitializeStableSwapInstructionsRaw = ({ provider, initializeSwapInstruction, }) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
 ...
 */
const deployNewSwap = (_a) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
    var { enableLogging = false } = _a, args = (0, tslib_1.__rest)(_a, ["enableLogging"]);
 ...
 */
const createInitializeNewSwapTx = (args) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
    const { provider } = args;
